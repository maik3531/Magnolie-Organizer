...
| Android | [Magnolie Notes APK](https://github.com/maik3531/Magnolie-Organizer/releases/latest/download/Magnolie-Notes-1.0.11.apk) | Android 8.0 or newer |
...
| Magnolie Notes for Android | Kotlin, Jetpack Compose | [`magnolie-notes-1.0.11`](magnolie-notes-1.0.11/) |
...
contains the published sources for release 2.0.15 / Notes 1.0.11; generated
