...
zusätzlich den passenden BlueZ-RFCOMM-Empfänger; die Windows-Ausgabe verwendet
derzeit ausschließlich den Netzwerkweg. Unter Linux führen WLAN und Bluetooth
in denselben verschlüsselten Magnolienbaum-Handler. Beim Versand gilt dort die
...
`release_pruefen_und_bauen.sh` bietet keine Überspringmöglichkeit. Ein externes
