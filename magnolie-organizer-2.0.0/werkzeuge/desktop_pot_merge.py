...
def main():
    ...
    roots = {"linux": (linux, linux / "po"),
             "windows": (linux.parent / "Magnolie-Organizer-Windows-2.0.0",
                         linux.parent / "Magnolie-Organizer-Windows-2.0.0/app/po")}
    ...
    test_command = ["python3", "-m", "pytest", "-q",
        "magnolie-organizer-2.0.0/pruefungen/test_pot_source_coverage.py",
        "Magnolie-Organizer-Windows-2.0.0/tests/test_windows_pot_source_coverage.py",
        "magnolie-organizer-2.0.0/pruefungen/test_setup_services.py",
        "magnolie-organizer-2.0.0/pruefungen/test_phone_setup_sessions.py",
        "magnolie-organizer-2.0.0/pruefungen/test_phone_bluetooth_setup.py"]
