...
"$DOTNET" build magnolie-organizer-2.0.0/pruefungen/sms-native/SmsProbe.csproj \
  -p:BaseIntermediateOutputPath=/tmp/opencode/aur-sms-native/obj/ \
  -p:OutputPath=/tmp/opencode/aur-sms-native/bin/ \
  -p:PhoneNumbersPath="$PWD/Magnolie-Organizer-Windows-2.0.0/tests/bin/Release/net8.0/PhoneNumbers.dll" \
