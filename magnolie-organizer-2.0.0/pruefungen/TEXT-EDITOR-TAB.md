...
- Linux: `magnolie-organizer-2.0.0/web/`
- Windows: `Magnolie-Organizer-Windows-2.0.0/app/web/`
...
sh magnolie-organizer-2.0.0/pruefungen/text_editor_isolated.sh --web linux
sh magnolie-organizer-2.0.0/pruefungen/text_editor_isolated.sh --web windows
```
