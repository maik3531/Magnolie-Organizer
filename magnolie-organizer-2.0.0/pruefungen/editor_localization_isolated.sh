...
evidence=${MAGNOLIE_EDITOR_L10N_EVIDENCE:-/tmp/opencode/editor-localization-webkit}
test -d "$evidence"
exec timeout --kill-after=5s 240s bwrap --die-with-parent --ro-bind / / \
  ...
  --ro-bind "$root/magnolie-organizer-2.0.0/pruefungen/editor_localization_webkit.py" /home/source/test.py \
  --ro-bind "$root/magnolie-organizer-2.0.0/pruefungen/context_edit_webkit.py" /home/source/context.py \
  --ro-bind "$root/magnolie-organizer-2.0.0/pruefungen/text_editor_webkit.py" /home/source/harness.py \
  --ro-bind "$root/tools/editor_locales.json" /home/source/editor_locales.json \
