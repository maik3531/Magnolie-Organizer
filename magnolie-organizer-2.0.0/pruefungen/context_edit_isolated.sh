#!/bin/sh
set -eu
# Focused ASR-05 source UI test, fixture bridge, private X/dev/home/network.
root=$(realpath "$(dirname "$0")/../..")
evidence=${MAGNOLIE_CONTEXT_EVIDENCE:-/tmp/opencode/context-edit-native}
test -d "$evidence"
exec timeout --kill-after=5s 240s bwrap --die-with-parent --ro-bind / / \
  ...
  --ro-bind "$root/magnolie-organizer-2.0.0/pruefungen/context_edit_webkit.py" /home/source/test.py \
