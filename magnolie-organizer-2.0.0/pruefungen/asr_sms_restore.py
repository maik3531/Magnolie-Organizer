...
W = ROOT / "Magnolie-Organizer-Windows-2.0.0"
BEFORE = "--before" in sys.argv


def linux_restore():
    source = ROOT / "magnolie-organizer-2.0.0/bin/magnolie-organizer"
...
def linux_captured_sms(work, commands):
    sys.path.insert(0, str(ROOT / "magnolie-organizer-2.0.0/bin"))
