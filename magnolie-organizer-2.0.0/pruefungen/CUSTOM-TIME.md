...
`Magnolie-Organizer-Windows-2.0.0/tests/custom-time-regressions.js` exercises both
...
```sh
taskset -c 0,1 bun Magnolie-Organizer-Windows-2.0.0/tests/custom-time-regressions.js
sh magnolie-organizer-2.0.0/pruefungen/custom_time_isolated.sh --web /usr/share/magnolie-organizer/web --output /tmp/evidence/installed-before --before
sh magnolie-organizer-2.0.0/pruefungen/custom_time_isolated.sh --web magnolie-organizer-2.0.0/web --output /tmp/evidence/linux-after
sh magnolie-organizer-2.0.0/pruefungen/custom_time_isolated.sh --web Magnolie-Organizer-Windows-2.0.0/app/web --output /tmp/evidence/windows-after
```
