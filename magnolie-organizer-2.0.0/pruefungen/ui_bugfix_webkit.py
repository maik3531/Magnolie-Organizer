...
script = (ROOT / "Magnolie-Organizer-Windows-2.0.0/tests/ui-bugfix-probe.js").read_text()
...
for platform, relative in (("linux", "magnolie-organizer-2.0.0/web"), ("windows", "Magnolie-Organizer-Windows-2.0.0/app/web")):
    web = ROOT / relative
