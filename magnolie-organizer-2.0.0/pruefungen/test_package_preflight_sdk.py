...
def inputs(tmp_path, monkeypatch):
    ...
    for name in ('magnolie-organizer-2.0.0/po/magnolie-organizer.pot',
                 'magnolie-organizer-2.0.0/werkzeuge/source_selection.py',
                 'Magnolie-Organizer-Windows-2.0.0/tests/Program.cs',
                 'Magnolie-Organizer-Windows-2.0.0/app/po/magnolie-organizer.pot',
