...
internal static class BridgeDispatcherContract
{
    ...
    private static readonly IReadOnlyDictionary<string, Schema> Schemas = new Dictionary<string, Schema>(StringComparer.Ordinal)
    {
        ...
        ["speichern"] = S(N("id"), T("text")), ["contributor_pruefen"] = S(T("key")), ["beenden_bereit"] = S(), ["beenden_abgebrochen"] = S(),
        ...
        ["journal_vorschau"] = S(O("snapshotId", JsonValueKind.String), O("id", JsonValueKind.String)), ["journal_intervall"] = S(T("intervall")),
        ["journal_loeschen"] = S(O("snapshotId", JsonValueKind.String), O("id", JsonValueKind.String)), ["journal_wiederherstellen"] = S(O("snapshotId", JsonValueKind.String), O("id", JsonValueKind.String)),
        ...
        ["baum_briefkasten_speichern"] = S(B("davAktiv"), B("briefkastenAktiv"), T("url"), T("benutzer"), T("anwendungskennwort"), B("kennwortLoeschen")),
        ...
        ["telefon_entfernen"] = S(T("kennung")), ["telefon_status_anfordern"] = S(T("kennung")), ["telefon_oeffnen"] = S(T("kennung")),
        ...
        ["kde_sms_senden"] = S(T("nummer"), T("text"), T("land"), T("clientRef")),
