...
Magnolie program and handbook sources are free software under the GNU General
Public License, version 3 or any later version, unless an individual file states
otherwise. The complete GPL-3.0 text is included with the Windows source in
...
Die Programm- und Handbuchquellen von Magnolie sind freie Software unter der
GNU General Public License, Version 3 oder jeder späteren Version, soweit eine
einzelne Datei nichts anderes bestimmt. Der vollständige GPL-3.0-Text liegt den
Windows-Quellen unter
[`Magnolie-Organizer-Windows-2.0.0/LICENSE`](Magnolie-Organizer-Windows-2.0.0/LICENSE)
bei.
