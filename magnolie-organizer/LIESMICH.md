...
Organizer-Aktualisierungen enthalten zusätzlich das passende AppImage:
    ...
    <appimage>
      ...
      <url>https://…/Magnolie-Organizer-2.0.21-x86_64.AppImage</url>
      <sha256>64 hexadezimale Zeichen</sha256>
    </appimage>
...
Das fertige Paket liegt danach eine Ebene höher und wird installiert mit:
    ...
    sudo apt install ../magnolie-organizer_2.0.21_all.deb
...
Das Paket `magnolie-organizer-kde_2.0.21_amd64.deb` ist identisch auf:
...
`magnolie-organizer-2.0.21.tar.xz` mit dem gleichnamigen obersten Verzeichnis
...
beispielsweise mit (die Fedora-Version bei Bedarf anpassen):
    ...
    mock -r fedora-42-x86_64 --rebuild \
        bau/rpm/fedora/SRPMS/magnolie-organizer-2.0.21-1.fc42.src.rpm
    rpmlint bau/rpm/fedora/SPECS/magnolie-organizer.spec \
        bau/rpm/fedora/SRPMS/magnolie-organizer-2.0.21-1.fc42.src.rpm \
        bau/rpm/fedora/RPMS/noarch/magnolie-organizer-2.0.21-1.fc42.noarch.rpm
...
die Paket-Scriptlets Firewallregeln öffnen oder Benutzerdaten verändern:
    ...
    sudo dnf install bau/rpm/fedora/RPMS/noarch/magnolie-organizer-2.0.21-1.fc42.noarch.rpm
...
festgeschrieben. Gebaut und gegen den gepackten Programmkern geprüft wird mit:
    ...
    pruefungen/test_appimage.sh ../Magnolie-Organizer-2.0.21-x86_64.AppImage
...
`MAGNOLIE_GRAPHICS_COMPAT=1 ./Magnolie-Organizer-2.0.21-x86_64.AppImage`. Der
...
Audiosocket funktioniert sowohl mit PulseAudio als auch mit `pipewire-pulse`.
    ...
    flatpak install --user ../Magnolie-Organizer-2.0.21-x86_64.flatpak

Das Ergebnis liegt als `Magnolie-Organizer-2.0.21-x86_64.flatpak` eine Ebene
...
Maschinen-Testbed ausgeführt werden:
    ...
    autopkgtest ../magnolie-organizer_2.0.21.dsc -- qemu TESTABBILD
