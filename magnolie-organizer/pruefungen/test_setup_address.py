...
def test_optional_cue_is_already_localized_in_all_native_catalogs():
    catalog = json.loads((ROOT.parent / "magnolie-organizer-windows/app/native-i18n.json").read_text())
    ...
    for path in (ROOT / "po").glob("*.po"):
        ...
        native_po = ROOT.parent / "magnolie-organizer-windows/app/po" / path.name
