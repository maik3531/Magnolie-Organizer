...
exec timeout --kill-after=5s 240s bwrap --die-with-parent --ro-bind / / \
  ...
  --ro-bind "$root/magnolie-organizer/pruefungen/editor_localization_webkit.py" /home/source/test.py \
  --ro-bind "$root/magnolie-organizer/pruefungen/context_edit_webkit.py" /home/source/context.py \
