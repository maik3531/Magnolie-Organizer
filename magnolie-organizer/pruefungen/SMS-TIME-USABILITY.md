...
MAGNOLIE_TIME_EVIDENCE=/tmp/opencode/sms-time-usability-20260914 \
  sh magnolie-organizer/pruefungen/custom_time_isolated.sh \
  --web magnolie-organizer/web --output /tmp/evidence/linux-de \
  --locale de --all-locales
```

Use `magnolie-organizer-windows/app/web` for the Windows frontend, and
