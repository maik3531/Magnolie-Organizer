...
def test_projection_must_match_recorded_sources_and_all_shared_contracts(tmp_path):
    ...
    record = {
        "magnolie-organizer/native/akonadi-helper/extra.cpp": sources.source_identity(tmp_path / "native/akonadi-helper/extra.cpp"),
        "magnolie-organizer/contracts/new.json": "stale internal projection",
        "contracts/new.json": sources.source_identity(tmp_path / "contracts/new.json"),
    }
    sources.verify_projection(record, "magnolie-organizer", tmp_path)
