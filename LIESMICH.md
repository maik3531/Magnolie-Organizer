...
Hilfsrahmen ist voreingestellt aus, damit die Papierdarstellung unverändert
...
den Debian-Quell- und Paketbau sowie AppImage-Bau und AppImage-Prüfung aus. Ein
Fehler beendet den Bau, sodass keine künftige Fassung ohne diese Prüfungen als
vollständiger Release gilt.
...
`bin/magnolie-organizer` fest eingebettet. Solange dort kein Schlüssel
eingetragen ist, arbeitet die Aktualisierungsprüfung wie bisher mit der streng
begrenzten HTTPS-Paketadresse, aber ohne Signaturprüfung.
